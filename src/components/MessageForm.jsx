...
export const MessageForm = () => {
  ...
  return (
    <form name="contact" method="POST" data-netlify="true"onSubmit={handleSubmit} className='flex flex-col justify-center items-center mt-10 text-stone-200 h-auto w-full border-t border-stone-500'>
      ...
      <label>Message:</label>
      <textarea  name="message" id='message' value={message} rows={8} cols={24} onChange={(e) => setMessage(e.target.value)} required className='rounded bg-stone-900 mt-1 text-center focus:outline-none focus:ring-1 focus:ring-stone-500' style={{ width: '50%' }}/>
