    ...
    <div className='text-stone-200 bg-stone-500 text-sm h-10 mt-10 flex items-center justify-center'>
      <div className='mx-5 flex justify-between w-full'> 
        <div>
          ...
          <a href="mailto:linda.lottiger@gmail.com" className='md:hidden block'><TfiEmail className='h-6 w-6 text-stone-200' /></a>
        </div>
        <div>
        ...
        <div>
          ...
          <a href="tel:+46768256943" className='md:hidden block'><FiPhoneCall className='h-6 w-6 text-stone-200' /></a>
        </div>
      </div>
    </div>
  )
